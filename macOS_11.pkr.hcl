...
variable "iso_file_checksum" {
  type    = string
  default = "file:../packer-macOS-11/install_bits/macOS_1123_installer.shasum"
}

variable "iso_filename" {
  type    = string
  default = "../packer-macOS-11/install_bits/macOS_1123_installer.iso"
}
...
variable "xcode" {
  type    = string
  default = "../packer-macOS-11/install_bits/Xcode_12.4.xip"
}

variable "xcode_cli" {
  type    = string
  default = "../packer-macOS-11/install_bits/Command_Line_Tools_for_Xcode_12.4.dmg"
}
